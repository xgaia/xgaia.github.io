...
- Pour obtenir le graph interactif d'interrogation des données, une requête SPARQL est effectué. Pourquoi cette requête est-elle rapide ?

--

 * On interroge la description des données, qui est
...
- Pour identifier un jeu de donnée publique, une icon représentant la terre est affiché. Mais quel continent la terre nous montre ?
...
<div class="box box-info">
    <p><center>
        <i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i>
    L'Afrique
    <i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i><i class="fas fa-globe-africa"></i>
    </center></p>
<div>
